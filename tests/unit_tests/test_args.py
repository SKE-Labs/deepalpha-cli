...
from deepalpha.main import parse_args
...
class TestInitialPromptArg:
    ...
    def test_empty_string(self) -> None:
        ...
        with patch.object(sys, "argv", ["deepalpha", "-m", ""]):
            args = parse_args()
