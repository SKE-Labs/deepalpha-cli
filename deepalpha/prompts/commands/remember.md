...
**Global** (`~/.deepalpha/agent/AGENTS.md`): Universal preferences across all projects
**Project** (`.deepalpha/AGENTS.md`): Project-specific conventions and decisions
...
### Skill Location
`~/.deepalpha/agent/skills/<skill-name>/SKILL.md`
