"""Park API client for DeepAlpha CLI.
...
Usage:
    from deepalpha.clients import park_client
...
from deepalpha.clients.basement import AuthenticationError

logger = logging.getLogger(__name__)

# Default Park API URL
PARK_API_URL = os.environ.get("PARK_API", "https://park.deepalpha.mn")
