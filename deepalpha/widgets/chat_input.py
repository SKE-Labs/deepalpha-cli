"""Chat input widget for deepalpha-cli with autocomplete and history support."""
...
from deepalpha.widgets.history import HistoryManager
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            history_file: Path to history file (default: ~/.deepalpha/history.jsonl)
        ...
        if history_file is None:
            history_file = Path.home() / ".deepalpha" / "history.jsonl"
