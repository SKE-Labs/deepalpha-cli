...
- deepalpha skills list --agent <agent> [--project]
- deepalpha skills create <name>
- deepalpha skills info <name>
"""
...
from deepalpha.config import COLORS, Settings, console
...
def _list(agent: str, *, project: bool = False) -> None:
    ...
    if project:
        ...
        if not project_skills_dir.exists() or not any(project_skills_dir.iterdir()):
            ...
            console.print(
                "\n[dim]Create a project skill:\n  deepalpha skills create my-skill --project[/dim]",
                style=COLORS["dim"],
            )
            return
        ...
        if not skills:
            ...
            console.print(
                "[dim]Skills will be created in ~/.deepalpha/agent/skills/ when you add them.[/dim]",
                style=COLORS["dim"],
            )
            console.print(
                "\n[dim]Create your first skill:\n  deepalpha skills create my-skill[/dim]",
                style=COLORS["dim"],
            )
            return
...
# license: Apache-2.0
# compatibility: Designed for deepalpha CLI
# metadata:
#   author: your-org
#   version: "1.0"
...
"""
    ...
    console.print(
        ...
        f"  nano {skill_md}\n"
        "\n"
        "💡 See examples/skills/ in the deepalpha repo for example skills:\n"
        "   - web-research: Structured research workflow\n"
        "   - langgraph-docs: LangGraph documentation lookup\n"
        "\n"
        "   Copy an example: cp -r examples/skills/web-research ~/.deepalpha/agent/skills/\n",
        style=COLORS["dim"],
    )
...
def execute_skills_command(args: argparse.Namespace) -> None:
    ...
    if args.skills_command == "list":
        ...
        console.print("  deepalpha skills <command> [options]\n")
        ...
        console.print("  deepalpha skills list")
        console.print("  deepalpha skills create web-research")
        console.print("  deepalpha skills info web-research")
        console.print("\n[dim]For more help on a specific command:[/dim]", style=COLORS["dim"])
        console.print("  deepalpha skills <command> --help", style=COLORS["dim"])
